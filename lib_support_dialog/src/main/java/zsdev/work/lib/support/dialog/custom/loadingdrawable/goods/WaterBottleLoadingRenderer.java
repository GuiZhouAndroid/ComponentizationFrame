package zsdev.work.lib.support.dialog.custom.loadingdrawable.goods;
...
public class WaterBottleLoadingRenderer extends LoadingRenderer {
    ...
    private static final int DEFAULT_BOTTLE_COLOR = Color.parseColor("#FF0244");
    private static final int DEFAULT_WATER_COLOR = Color.parseColor("#0FDBEC");
    ...
    private static class WaterDropHolder {
