...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    protected void draw(Canvas canvas, Rect bounds) {
        ...
        for (int i = 0; i < mSunRayCount; i++) {
            ...
            canvas.rotate(45 - mSunRayRotation + (mIsExpandSunRay ? i : MAX_SUN_RAY_COUNT - i) * DEGREE_360 / MAX_SUN_RAY_COUNT,
    ...
    private class StarHolder {
        ...
        public StarHolder(float flashOffset, PointF mPoint) {
            ...
            this.mInterpolator = INTERPOLATOR[mRandom.nextInt(INTERPOLATOR.length)];
        }
    }
