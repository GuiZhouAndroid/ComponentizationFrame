package zsdev.work.lib.support.dialog.custom.loadingdrawable.scenery;
...
public class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private static final Interpolator[] INTERPOLATOR = new Interpolator[]{LINEAR_INTERPOLATOR,
            DECELERATE_INTERPOLATOR, ACCELERATE_INTERPOLATOR, FAST_OUT_LINEAR_IN_INTERPOLATOR, MATERIAL_INTERPOLATOR};
    ...
    private static final int DEFAULT_PROGRESS_BG_COLOR = 0xfffcd49f;
    private static final int DEFAULT_ELECTRIC_FAN_BG_COLOR = 0xfffccc59;
    ...
    private void init(Context context) {
        ...
        mProgressBgColor = DEFAULT_PROGRESS_BG_COLOR;
        mElectricFanBgColor = DEFAULT_ELECTRIC_FAN_BG_COLOR;
    ...
    private Animator getAnimator(LeafHolder target, RectF leafFlyRect, float progress) {
        ...
        finalSet.setInterpolator(INTERPOLATOR[mRandom.nextInt(INTERPOLATOR.length)]);
