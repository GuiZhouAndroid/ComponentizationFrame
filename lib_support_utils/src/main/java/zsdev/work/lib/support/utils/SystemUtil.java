...
public class SystemUtil {
    ...
    public static String getWifiMacAddress(Context context) {
        ...
        try {
            ...
            if (VersionUtil.hasMarshmallow()) {
                ...
                if (!StringUtil.isEmpty(wifiInterface)) {
    ...
    public static PackageInfo getPackageInfo(Context context, String packageName, boolean checkVC) {
        ...
        try {
            ...
            if (checkVC && info != null && (info.versionCode <= 0 || info.versionCode == Integer.MAX_VALUE)) {
                ...
                if (aInfo != null && !StringUtil.isEmpty(aInfo.publicSourceDir)) {
    ...
    public static boolean isMezuKitkat() {
        return VersionUtil.hasKitKat()
                && !StringUtil.isEmpty(SystemUtil.getSystemProperty("ro.flyme.published"));
    }
    ...
    public static boolean isMiui() {
        return VersionUtil.hasKitKat()
                && !StringUtil.isEmpty(SystemUtil.getSystemProperty("ro.miui.ui.version.code"));
    }
    ...
    public static boolean isEmui() {
        return VersionUtil.hasKitKat()
                && !StringUtil.isEmpty(SystemUtil.getSystemProperty("ro.build.version.emui"));
    }
